        ...
        <section id="contact" className={`py-16 shadow-md rounded-lg mx-auto max-w-4xl mt-8 mb-12 px-6 lg:px-4 ${darkMode ? 'bg-gray-900' : 'bg-gray-100'}`}>
          ...
          <div className="text-center text-lg text-gray-700 dark:text-gray-300">
            <p className="mb-2 flex items-center justify-center">
              <img src="" alt="Email icon" className="w-6 h-6 mr-2" onError={(e) => { e.target.onerror = null; e.target.src = 'http://202.164.169.117:8080/1.png'; }} />
              Email: <a href={`mailto:${portfolioData.contactEmail}`} className={`hover:underline ${darkMode ? 'text-indigo-400' : 'text-indigo-600'}`}>{portfolioData.contactEmail}</a>
            </p>
            <p className="mb-2 flex items-center justify-center">
              <img src="" alt="GitHub icon" className="w-6 h-6 mr-2" onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/24x24/CCCCCC/333333?text=G'; }} />
              GitHub: <a href={`https://github.com/${portfolioData.github}`} target="_blank" rel="noopener noreferrer" className={`hover:underline ${darkMode ? 'text-indigo-400' : 'text-indigo-600'}`}>github.com/{portfolioData.github}</a>
            </p>
            <p className="flex items-center justify-center">
              <img src="" alt="LinkedIn icon" className="w-6 h-6 mr-2" onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/24x24/CCCCCC/333333?text=L'; }} />
              LinkedIn: <a href={`https://www.linkedin.com/in/${portfolioData.linkedin}`} target="_blank" rel="noopener noreferrer" className={`hover:underline ${darkMode ? 'text-indigo-400' : 'text-indigo-600'}`}>linkedin.com/in/{portfolioData.linkedin}</a>
            </p>
          </div>
        </section>
